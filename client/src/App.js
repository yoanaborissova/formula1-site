      ...
      <div className="App">
          <div id="container">
            ...
            <Switch>
              ...
              <Route render={(props) => this.state.username ? <MyOrders isAdmin={this.state.isAdmin} orders={this.setState.orders} handleEditDeleteSubmit={this.handleEditDeleteSubmit} username={this.username} {...this.state} {...props}/> : <Redirect to={{ pathname: '/login' }} />} path="/myorders" exact/>
